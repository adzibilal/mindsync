  ...
  return (
    ...
    >
            ...
            <Link key={item.href} href={item.href}>
              <Button
                ...
                className={cn(
                  ...
                  isActive && "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-400"
                )}
              >
      ...
      <div className="p-4">
        ...
        <Button
          variant="ghost"
          className="mt-2 w-full justify-start text-red-600 hover:bg-red-50 hover:text-red-700 dark:text-red-400 dark:hover:bg-red-950"
